...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'build_emscripten/app.data';
...
Module['FS_createPath']('/', 'src_asset', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_build_emscripten/app.data');

    };
    Module['addRunDependency']('datafile_build_emscripten/app.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 212, "filename": "/src_asset/stl.vert"}, {"start": 212, "audio": 0, "end": 344, "filename": "/src_asset/stl.frag"}], "remote_package_size": 344, "package_uuid": "e5d3c858-0ca0-4891-aea6-88097d6e3c21"});
...
function _get_canvas_client_height(){ return impl_get_canvas_client_height(); }
function _get_canvas_client_width(){ return impl_get_canvas_client_width(); }
function _get_vr_state(vr_state,vr_display_handle){ return impl_get_vr_state( vr_state, vr_display_handle ); }
function _set_canvas_size(width,height){ impl_set_canvas_size( width, height ); }



STATIC_BASE = GLOBAL_BASE;

STATICTOP = STATIC_BASE + 27152;
...
Module['wasmTableSize'] = 8321;

Module['wasmMaxTableSize'] = 8321;
...
var real____em_js__get_canvas_client_height = asm["___em_js__get_canvas_client_height"]; asm["___em_js__get_canvas_client_height"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__get_canvas_client_height.apply(null, arguments);
};

var real____em_js__get_canvas_client_width = asm["___em_js__get_canvas_client_width"]; asm["___em_js__get_canvas_client_width"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__get_canvas_client_width.apply(null, arguments);
};

var real____em_js__get_vr_state = asm["___em_js__get_vr_state"]; asm["___em_js__get_vr_state"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__get_vr_state.apply(null, arguments);
};

var real____em_js__set_canvas_size = asm["___em_js__set_canvas_size"]; asm["___em_js__set_canvas_size"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__set_canvas_size.apply(null, arguments);
};
...
var ___em_js__get_canvas_client_height = Module["___em_js__get_canvas_client_height"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__get_canvas_client_height"].apply(null, arguments) };
var ___em_js__get_canvas_client_width = Module["___em_js__get_canvas_client_width"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__get_canvas_client_width"].apply(null, arguments) };
var ___em_js__get_vr_state = Module["___em_js__get_vr_state"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__get_vr_state"].apply(null, arguments) };
var ___em_js__set_canvas_size = Module["___em_js__set_canvas_size"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__set_canvas_size"].apply(null, arguments) };
