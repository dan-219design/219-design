...
var ASM_CONSTS = [function() { FS.syncfs( false, function( err ) { assert( !err ); console.log( "Synced /indexdb contents." ); } ); },
 function() { FS.mkdir( '/indexdb' ); FS.mount( IDBFS, {}, '/indexdb' ); FS.syncfs( true, function( err ) { assert( !err ); console.log( "Created /indexdb." ); ccall( 'make_stl', 'v' ); } ); }];
...
var real__make_stl = asm["_make_stl"]; asm["_make_stl"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__make_stl.apply(null, arguments);
};
...
var _make_stl = Module["_make_stl"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_make_stl"].apply(null, arguments) };
