...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'build_emscripten/stl.data';
    var REMOTE_PACKAGE_BASE = 'stl.data';
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_build_emscripten/stl.data');

    };
    Module['addRunDependency']('datafile_build_emscripten/stl.data');
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'stl.wast';
  var wasmBinaryFile = 'stl.wasm';
  var asmjsCodeFile = 'stl.temp.asm.js';
...
function _get_canvas_client_height(){ return Module.canvas.clientHeight; }
function _get_canvas_client_width(){ return Module.canvas.clientWidth; }
function _set_canvas_size(width,height){ var c = Module.canvas; if( c.width !== width ) { c.width = width; } if( c.height !== height ) { c.height = height; } }
...
Module['wasmTableSize'] = 6977;

Module['wasmMaxTableSize'] = 6977;
